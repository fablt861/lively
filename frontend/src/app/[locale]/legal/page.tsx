...
export default function LegalPage() {
    ...
    const sections = [
        { title: t('legal.controller_title'), content: t('legal.controller_content') },
        { title: t('legal.data_types_title'), content: t('legal.data_types_content') },
        { title: t('legal.processing_title'), content: t('legal.processing_content') },
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white flex flex-col font-sans selection:bg-indigo-500/30">
            ...
            <main className="relative z-10 flex-1 w-full max-w-4xl mx-auto px-6 py-16 md:py-24">
                ...
                {/* Introduction */}
                <div className="mb-16 p-8 rounded-3xl bg-white/[0.01] border border-white/5 backdrop-blur-sm">

...
const files = ['de.json', 'en.json', 'es.json', 'fi.json', 'fr.json', 'it.json', 'nl.json', 'no.json', 'pt.json', 'ro.json', 'ru.json', 'sv.json', 'uk.json'];
...
files.forEach(file => {
    ...
    const newTranslations = translations[lang] || translations['en'];

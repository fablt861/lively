...
const keysToAdd = [
  "profile.2fa_title", "profile.2fa_enabled_desc", "profile.2fa_disabled_desc",
  "profile.2fa_enable", "profile.2fa_scan_qr", "profile.2fa_enter_code", "profile.2fa_disable",
  "auth.2fa_required_title", "auth.2fa_required_desc", "auth.error.invalid_totp"
];
...
for (const file of files) {
  ...
  for (const key of keysToAdd) {
    ...
    content[parts[0]][parts[1]] = translations[lang][key];
  }
